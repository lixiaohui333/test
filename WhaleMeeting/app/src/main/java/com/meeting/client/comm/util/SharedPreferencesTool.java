...
public class SharedPreferencesTool {
	...
	public static void clearEditor(Context paramContext) {
		getEditorObject(paramContext).clear().commit();
	}

	public static void setEditor(Context paramContext, String paramString,
			int paramInt) {
		getEditorObject(paramContext).putInt(paramString, paramInt).apply();
	}

	public static void setEditor(Context paramContext, String paramString,
			long paramLong) {
		getEditorObject(paramContext).putLong(paramString, paramLong).apply();
	}
